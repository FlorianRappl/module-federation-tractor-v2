...
const decideUrl = process.env.BASE_URL ? `${process.env.BASE_URL}decide/remoteEntry.js` : '';
...
module.exports = {
  ...
  plugins: [
    ...
    new rspack.DefinePlugin({
      ...
      "process.env.DECIDE_URL": JSON.stringify(decideUrl || "http://localhost:6003/remoteEntry.js"),
